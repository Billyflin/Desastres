...
import static main.Listas.getDisasterByCountry;
...
public class MainGui extends JFrame {
    ...
    private void dañosLabels(ArrayList<Desastre> listaDesastres, int index) {
    ...
    private void consultarTipo(String country) {
        ...
        button4.addActionListener(e -> dañosLabels(listaDesastres,index));
